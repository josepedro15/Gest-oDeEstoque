...
import { Loader2, Trash2, MessageSquare, Phone, Calendar, Edit, User, Clock, AlertCircle, Eye } from "lucide-react";
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="font-mono text-sm">{formatPhone(cliente.telefone)}</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-sm">{formatDate(cliente.data_ultimo_contato)}</p>
                              </div>
                            </div>
                          </div>
                        ...
                        {cliente.resumo_conversa && (
                          <div className="space-y-2">
                            <p className="text-sm font-medium text-muted-foreground">Resumo da Conversa:</p>
